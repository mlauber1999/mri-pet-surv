from cgan.plot.utils_stat import get_roc_info, get_pr_info, calc_neurologist_statistics, read_raw_score
import matplotlib.pyplot as plt
from cgan.plot.utils_plot import plot_curve, plot_legend, plot_neorologist
