function coregister_pet_mri_job(suffix)
    ...
    mkdir(newdir);
    system(['rsync -av /data2/MRI_PET_DATA/processed_images_final' suffix filesep 'coregistered_mri_to_amyloid' filesep '*' modal '.nii ' newdir filesep]);
    disp(['rsync -av /data2/MRI_PET_DATA/processed_images_final' suffix filesep 'coregistered_mri_to_amyloid' filesep '*' modal '.nii ' newdir filesep])
    ...
    matlabbatch{2}.spm.tools.cat.estwrite.output.GM.mod = 1;
    ...
    matlabbatch{2}.spm.tools.cat.estwrite.output.WM.mod = 1;
    ...
    matlabbatch{2}.spm.tools.cat.estwrite.output.CSF.mod = 1;
    ...
    matlabbatch{2}.spm.tools.cat.estwrite.output.TPMC.native = 1;
    matlabbatch{2}.spm.tools.cat.estwrite.output.TPMC.warped = 1;
    matlabbatch{2}.spm.tools.cat.estwrite.output.TPMC.mod = 1;
    matlabbatch{2}.spm.tools.cat.estwrite.output.TPMC.dartel = 0;
    matlabbatch{2}.spm.tools.cat.estwrite.output.atlas.native = 1;
...
function matlabbatch = batch_process_amyloidmri(r, suffix)
    matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.parent = {['/data2/MRI_PET_DATA/processed_images_final' suffix]};
    matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.name = 'coregistered_mri_to_amyloid';
    matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {['/data2/MRI_PET_DATA/processed_images_final' suffix '/ADNI_MRI_nii_recenter' suffix]};
    matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = ['^' r '.*nii$'];
    matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
    matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {['/data2/MRI_PET_DATA/processed_images_final' suffix '/ADNI_AMYLOID_nii_recenter' suffix]};
    matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.filter = ['^' r '.*nii$'];
    matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
    matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_move.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^0746.*nii$)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_move.action.moveto(1) = cfg_dep('Make Directory: Make Directory ''coregistered_mri_to_amyloid''', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dir'));
    matlabbatch{5}.spm.spatial.coreg.estimate.ref(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^0746.*nii$)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    matlabbatch{5}.spm.spatial.coreg.estimate.source(1) = cfg_dep('Move/Delete Files: Moved/Copied Files', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
