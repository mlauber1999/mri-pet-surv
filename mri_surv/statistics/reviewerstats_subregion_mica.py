...
# lobe_dict = {'mesial_temp':['mesial_temp','hippocampus','amygdala','parahippocampus','entorhinal'],
#              'temporal_lobe_other':['temporal','fusiform','inftemporalgyrus'],
#              'insula':['insula'],
...
lobe_dict = {'mesial_temp':['mesial_temp'],
